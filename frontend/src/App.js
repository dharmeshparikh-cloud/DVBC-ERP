...
const AdditionalMeetingRequests = lazy(() => import('./pages/consulting/AdditionalMeetingRequests'));
const ConsultantExpenses = lazy(() => import('./pages/consulting/ConsultantExpenses'));
...
const PenaltyManagement = lazy(() => import('./pages/PenaltyManagement'));
  ...
  return (
    ...
    <Routes>
      ...
      >
        ...
        <Route path="sales-funnel/proforma-invoices" element={<RoleGuard allowedRoles={['executive', 'sales_manager', 'manager', 'admin']} allowedDepts={['Sales', 'Admin']}><ProformaInvoice /></RoleGuard>} />
        ...
        <Route path="sales-funnel/agreements" element={<RoleGuard allowedRoles={['executive', 'sales_manager', 'manager', 'admin']} allowedDepts={['Sales', 'Admin']}><Agreements /></RoleGuard>} />
        <Route path="sales-funnel/agreement/:agreementId" element={<RoleGuard allowedRoles={['executive', 'sales_manager', 'manager', 'admin']} allowedDepts={['Sales', 'Admin']}><AgreementView /></RoleGuard>} />
        <Route path="sales-funnel/agreement" element={<RoleGuard allowedRoles={['executive', 'sales_manager', 'manager', 'admin']} allowedDepts={['Sales', 'Admin']}><AgreementView /></RoleGuard>} />
        ...
        <Route path="penalty-management" element={<RoleGuard allowedRoles={['admin', 'hr_manager']} allowedDepts={['HR', 'Admin']}><PenaltyManagement /></RoleGuard>} />
