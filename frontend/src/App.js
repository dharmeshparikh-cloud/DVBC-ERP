  ...
  return (
    ...
    <Routes>
      ...
      >
        ...
        <Route path="sales-funnel/proforma-invoices" element={<RoleGuard allowedRoles={['executive', 'sales_manager', 'manager', 'admin', 'principal_consultant']} allowedDepts={['Sales', 'Admin', 'Consulting']}><ProformaInvoice /></RoleGuard>} />
