  ...
  return (
    <div data-testid="approvals-center" className={isDark ? 'text-zinc-100' : ''}>
      ...
      <BulkActionsBar
        ...
        onApproveAll={() => openBulkActionDialog('approve')}
        onRejectAll={() => openBulkActionDialog('reject')}
      ...
      <ApprovalStats
        ...
        modificationApprovals={modificationApprovals}
        profileChangeApprovals={profileChangeApprovals}
        agreementApprovals={agreementApprovals}
        kickoffApprovals={kickoffApprovals}
