        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
              ...
              <div className="mt-6 p-4 bg-black/5 rounded-xl">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-semibold text-emerald-600">{fmtTime24IST(checkInStatus?.check_in_time)}</p>
                  </div>
                  <div>
                    <p className="text-black/50">Check-out</p>
                    <p className="font-semibold text-red-600">{fmtTime24IST(checkInStatus?.check_out_time)}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-black/60 mb-2">Since {fmtTime24IST(checkInStatus?.check_in_time)}</p>
