from fastapi import FastAPI, APIRouter, HTTPException, Depends, status, Response, Request, File, UploadFile
...
SALES_ROLES = ["admin", "executive", "sales_manager"]  # Can create & edit SOW
...
# ===== SALES TARGETS ENDPOINTS - MOVED TO routers/sales.py =====
# The following endpoints have been moved to the dedicated sales router:
# - POST /sales-targets
# - GET /sales-targets
# - PATCH /sales-targets/{target_id}
# - DELETE /sales-targets/{target_id}
# - PATCH /sales-targets/{target_id}/approve
...
# ==============================
# SALES MEETINGS & MOM ENDPOINTS - MOVED TO routers/sales.py
# ==============================
# The following endpoints have been moved to the dedicated sales router:
# - POST /sales-meetings
# - GET /sales-meetings
# - GET /sales-meetings/{meeting_id}
# - PATCH /sales-meetings/{meeting_id}
# - POST /sales-meetings/{meeting_id}/complete
# - POST /sales-meetings/{meeting_id}/mom
# - GET /sales-meetings/{meeting_id}/mom
# - GET /leads/{lead_id}/meetings
# - GET /leads/{lead_id}/mom-history

# NOTE: SalesMeetingCreate and MOMCreate models are now defined in routers/sales.py
...
async def create_agreement(agreement_create: AgreementCreate, current_user: User = Depends(get_current_user)):
    ...
    # Update lead status to "agreement" when agreement is created
    # Final status will be "closed" after manager approval
    lead_id = agreement_create.lead_id
    if lead_id:
        await db.leads.update_one(
            {"id": lead_id},
            {"$set": {
