...
async def send_onboarding_invite(
    ...
    base_url = os.environ.get("FRONTEND_URL", "https://deliverable-status.preview.emergentagent.com")
...
async def send_onboarding_reminder(
    ...
    # Send reminder email
    try:
        frontend_url = os.environ.get("FRONTEND_URL", "https://deliverable-status.preview.emergentagent.com")
