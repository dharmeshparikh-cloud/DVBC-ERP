...
async def approve_go_live_request(
    ...
    if employee_full:
        ...
        # ERP Login URL
        erp_login_url = os.environ.get("FRONTEND_URL", "https://ssot-forms.preview.emergentagent.com") + "/login"
                    ...
                    await send_email(
                        ...
                        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                            ...
                            <div style="padding: 30px; background: #f9f9f9;">
                                ...
                                <p>You can view their details in the <a href="https://ssot-forms.preview.emergentagent.com/employees?edit={employee_full.get('id')}">Employee Directory</a>.</p>
                            </div>
                        </div>
                        """
                    )
